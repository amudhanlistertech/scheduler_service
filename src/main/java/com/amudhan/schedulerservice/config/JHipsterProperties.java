...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "schedulerservice@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "schedulerservice API";

        private String description = "schedulerservice API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "schedulerservice";
